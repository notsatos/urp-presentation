...
\begin{rem}
The simplest affine schemes to write down are of the form $(\spec R, \mathcal{O}_{\spec R}) $ for some ring $R$, or for a given ring $A$, and $x_1, x_2, \ldots, x_n$ indeterminants, $\spec A[x_1, x_2, \ldots, x_n ] := \aff^n_A$ (note that we are going to omitting the strucutre sheaf in the notation when we talk about affine schemes of this form simply for simplicity). This defining property of an affine scheme where we take points from $\spec A[x_1, x_2, \ldots, x_n ]$ will be very important as to how we approach any sort of visualization of a scheme. 
\end{rem}
